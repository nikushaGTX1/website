...
const routes: Routes = [
  ...
  { path: 'main', component: Main, title: 'Verified Apartments for Rent in Tbilisi | Velven' },
  { path: 'ExploreProperty', component: ExploreProperty, title: 'Explore Apartments in Tbilisi | Velven' },
  { path: 'apartments/:id', component: ApartmentDetail, title: 'Apartment Details | Velven' },
  { path: 'find-my-home', component: AiConciergePageComponent, title: 'Find My Home | Velven' },
  { path: 'ai-home-match', component: AiHomeMatchPageComponent, title: 'AI Home Matcher | Velven' },
  { path: 'about', component: AboutUs, title: 'About Us | Velven' },
  { path: 'services', component: Services, title: 'Real Estate Services | Velven' },
  { path: 'apartment-detail', component: ApartmentDetail, title: 'Apartment Details | Velven' },
  { path: 'agent-profile', component: AgentProfile, title: 'Real Estate Agents in Tbilisi | Velven' },
  { path: 'agent-profile/:id', component: AgentDetailProfile, title: 'Agent Profile | Velven' },
  { path: 'login', component: Login, title: 'Sign In | Velven', canActivate: [guestGuard] },
